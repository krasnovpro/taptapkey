...
(function() {
	...
	mainDialog.prototype.init = function() {
		...
		thisObj.rdTarget = {
			'fillColor' : thisObj.targetPanel.add('checkbox', undefined, 'Fill'),
			'strokeColor' : thisObj.targetPanel.add('checkbox', undefined, 'Stroke')
		};
		...
		thisObj.rdMethod = [
			thisObj.methodPanel.add('radiobutton', undefined, 'Std'),
			thisObj.methodPanel.add('radiobutton', undefined, 'Floor'),
			thisObj.methodPanel.add('radiobutton', undefined, 'Ceil')
		];
		...
		thisObj.rdType = [
			thisObj.typePanel.add('radiobutton', undefined, '1％'),
			thisObj.typePanel.add('radiobutton', undefined, '5％'),
			thisObj.typePanel.add('radiobutton', undefined, '10％')
		];
