/*
  ToggleTextUnderline.jsx for Adobe Illustrator
  Description: Toggle underline on selected text or text frame
  Date: October, 2025
...
/**
 * Toggle underline attribute for all characters in a text range
...
function toggleUnderline(text) {
  ...
  var isCurrUnderlined = _chars[0].characterAttributes.underline;
  if (text.typename === 'TextRange') {
    text.characterAttributes.underline = !isCurrUnderlined;
  } else {
    text.textRange.characterAttributes.underline = !isCurrUnderlined;
  }
}
