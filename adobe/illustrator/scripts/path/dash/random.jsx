// 2007-12-13
// Crazy Dashes © Keegan Green
// https://scriptographer.org/scripts/general-scripts/crazy-dashes/
...
win = new Window('dialog', 'Random Dashes \u00A9 Keegan Green, UI: Alexander Ladygin');
...
with(win.add('panel', undefined, 'Dash:')) {
  ...
  with(add('group')) {
    with(add('group')) {
      ...
      __minDashSlider.onChanging = function(e) {
        __minDashInput.text = Math.round(this.value);
      }
      // __minDashSlider.onChange = function (e) { previewStart(); }
      __minDashInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __minDashSlider.minvalue, __minDashSlider.maxvalue);
      });
      __minDashInput.addEventListener('keyup', function(e) {
        __minDashSlider.value = Math.round(this.text);
      });
    ...
    with(add('group')) {
      ...
      __maxDashSlider.onChanging = function(e) {
        __maxDashInput.text = Math.round(this.value);
      }
      // __maxDashSlider.onChange = function (e) { previewStart(); }
      __maxDashInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __maxDashSlider.maxvalue, __maxDashSlider.maxvalue);
      });
      __maxDashInput.addEventListener('keyup', function(e) {
        __maxDashSlider.value = Math.round(this.text);
      });
...
with(win.add('panel', undefined, 'Gap:')) {
  ...
  with(add('group')) {
    with(add('group')) {
      ...
      __minGapSlider.onChanging = function(e) {
        __minGapInput.text = Math.round(this.value);
      }
      // __minGapSlider.onChange = function (e) { previewStart(); }
      __minGapInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __minGapSlider.minvalue, __minGapSlider.maxvalue);
      });
      __minGapInput.addEventListener('keyup', function(e) {
        __minGapSlider.value = Math.round(this.text);
      });
    ...
    with(add('group')) {
      ...
      __maxGapSlider.onChanging = function(e) {
        __maxGapInput.text = Math.round(this.value);
      }
      // __maxGapSlider.onChange = function (e) { previewStart(); }
      __maxGapInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __maxGapSlider.maxvalue, __maxGapSlider.maxvalue);
      });
      __maxGapInput.addEventListener('keyup', function(e) {
        __maxGapSlider.value = Math.round(this.text);
      });
...
with(win.add('panel', undefined, 'Stroke:')) {
  ...
  with(add('group')) {
    with(add('group')) {
      ...
      __minStrokeSlider.onChanging = function(e) {
        __minStrokeInput.text = Math.round(this.value);
      }
      // __minStrokeSlider.onChange = function (e) { previewStart(); }
      __minStrokeInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __minStrokeSlider.minvalue, __minStrokeSlider.maxvalue);
      });
      __minStrokeInput.addEventListener('keyup', function(e) {
        __minStrokeSlider.value = Math.round(this.text);
      });
      // __minStrokeInput.onChange = function (e) { previewStart(); };
    }
    with(add('group')) {
      var __maxStrokeSlider = add('slider', [0, 0, 80, 15], 1, 1, 100),
        __maxStrokeInput = add('edittext', [0, 0, 40, 25], '1'),
        __maxStrokeText = add('statictext', undefined, 'Max');
      __maxStrokeInput.text = __maxStrokeSlider.value;

      __maxStrokeSlider.onChanging = function(e) {
        __maxStrokeInput.text = Math.round(this.value);
      }
      // __maxStrokeSlider.onChange = function (e) { previewStart(); }
      __maxStrokeInput.addEventListener('keydown', function(e) {
        inputNumberEvents(e, this, __maxStrokeSlider.maxvalue, __maxStrokeSlider.maxvalue);
      });
      __maxStrokeInput.addEventListener('keyup', function(e) {
        __maxStrokeSlider.value = Math.round(this.text);
      });
